...
<a href="{{ route('breweries') }}">
    <div class="d-flex justify-content-center align-items-center position-relative">
      ...
      <a href="{{ route('breweries') }}" class="btn btn-danger round-button" style="position: absolute; bottom: 10px; left: 50%; transform: translateX(-50%); background: radial-gradient(#cd3401, #714798); width: 75px; height: 75px; border-radius: 50%; display: flex; justify-content: center; align-items: center; box-shadow: 0 0 5px rgba(0, 0, 0, 0.3);">
